...
public class AuditAdminPageAuthFilter implements Filter {
    private final PermissionProvider permissionProvider;
    private final String basePath;

    public AuditAdminPageAuthFilter(PermissionProvider permissionProvider, String basePath) {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (isProtectedHtml(pathOf(httpRequest))
                && !permissionProvider.hasPermission(AuditPermission.AUDIT_VIEW, Optional.<String>empty())) {
