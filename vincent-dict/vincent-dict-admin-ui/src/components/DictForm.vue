<template>
  <el-form :model="form" label-width="80px" @submit.prevent="submit">
    <el-form-item v-if="mode === 'create'" label="编码">
      <el-input v-model="form.code" data-testid="dict-code" maxlength="64" :validate-event="false" />
    </el-form-item>
    ...
    <el-form-item label="排序">
      <el-input v-model.number="form.sortNo" data-testid="dict-sort" :disabled="readonly" />
    </el-form-item>
    <p v-if="codeError" class="code-error">{{ codeError }}</p>
    <el-form-item v-if="!readonly">
      <el-button data-testid="dict-submit" type="primary" native-type="submit">保存</el-button>
    </el-form-item>
  </el-form>
</template>
